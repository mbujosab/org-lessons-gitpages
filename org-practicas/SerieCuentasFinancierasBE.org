...
gretlcli -b $(pwd)/guiones/SerieCuentasFinancierasBE.inp
#+END_SRC
# echo "$(pwd)/guiones/SerieCuentasFinancierasBE" > directorioDeTrabajo


#+BEGIN_SRC sh  :exports none :results silent :eval no
zip SerieCuentasFinancierasBE SerieCuentasFinancierasBE* SerieCuentasFinancierasBE/*
#+END_SRC

#+begin_src R :tangle guiones/SerieCuentasFinancierasBE.inp :exports none
...
#+end_src
# string directory = readfile("../directorioDeTrabajo")

# /Adquisiciones netas de
# activos no financieros/. Zona euro. Total, Millones de Euros *Fuente
# Banco de España*

#+begin_src R :tangle guiones/SerieCuentasFinancierasBE.inp :results none :exports none
open be.bin
data BE_1_2_1
data BE_2_5_8_16
#+end_src
...
#+begin_src R :tangle guiones/SerieCuentasFinancierasBE.inp :results none :exports code 
...
#+begin_src R :tangle guiones/SerieCuentasFinancierasBE.inp :results none :exports none :noweb no-export 
# añadido para guardar los resultados en un fichero de texto
...
#+begin_src R :tangle guiones/SerieCuentasFinancierasBE.inp :results none :exports none :noweb yes 
# añadido para guardar los resultados en un fichero de texto
