...
#+name: gretl
#+BEGIN_SRC sh :exports none :results silent :tangle no
rm -fr $(pwd)/LetrasTesoroAmericano3y6meses
mkdir -p $(pwd)/LetrasTesoroAmericano3y6meses 
DIRECTORIO="$(pwd)/LetrasTesoroAmericano3y6meses" gretlcli -b $(pwd)/guiones/LetrasTesoroAmericano3y6meses.inp 
#+END_SRC
...
#+BEGIN_SRC sh  :exports none :results silent :tangle no :eval no
# zip LetrasTesoroAmericano3y6meses LetrasTesoroAmericano3y6meses* LetrasTesoroAmericano3y6meses/*#
#+END_SRC

#+BEGIN_SRC bash :exports none :results silent :tangle no :eval no
