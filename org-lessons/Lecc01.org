...
#+BEGIN_SRC jupyter-python :results file :file ./img/lecc01/stationaryTimeSeriesExample.png :results silent :noweb yes
...
************** COMMENT Codigo aux para generar el .png de la figura en batch
