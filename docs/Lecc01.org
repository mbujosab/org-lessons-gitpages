...
mpl.use("Agg")  # <-- ¡ESTO ES FUNDAMENTAL PARA GitHub Actions!
...
os.makedirs(imagenes_leccion, exist_ok=True)
#+END_SRC
...
#+RESULTS:
: 1ffc2cf6-ad73-483e-9adf-f715ed8fce32
...
#+RESULTS:
: 41fbb058-becc-4af3-9521-2f72d7bc1384
...
#+RESULTS:
: 3237b50c-88e7-403b-8ab1-f52896ea4691
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python :results file :file ./img/lecc01/ProduccionCemento.png
df2.plot(x='obs',xlabel='',figsize=(15,4)).set_title('Producción de cemento en España',fontsize=18)
#+END_SRC

#+RESULTS:
: 2ef72fa1-9154-4ed7-a923-e6670040b812
...
**************  Codigo aux para generar los .png de las figuras en batch :noexport:
...
#+BEGIN_SRC jupyter-python :results file :file ./img/lecc01/stationaryTimeSeriesExample.png
...
#+RESULTS: figura_serie_simulada
: 4f02af1c-40be-4c54-afef-a83d397f7dfe
...
**************  Codigo aux para generar el .png de la figura en batch :noexport:

#+BEGIN_SRC jupyter-python :results silent :noweb yes
fichero = './img/lecc01/stationaryTimeSeriesExample.png'
if not os.path.exists(fichero):
    <<figura_serie_simulada>>
    plt.savefig(fichero, dpi=300, bbox_inches='tight')
    plt.close()
#+END_SRC
...
#+BEGIN_SRC jupyter-python :results file :file ./img/lecc01/airlinepass+hist.png
plt.figure(figsize=(15,5))
plt.subplot(1, 2, 1)
...
#+RESULTS: figura-airlinepass
: aa276c8e-412d-4929-951f-963b897067ba
...
#+BEGIN_SRC jupyter-python :results silent :noweb yes
fichero = './img/lecc01/airlinepass+hist.png'
if not os.path.exists(fichero):
    <<figura-airlinepass>>
    plt.savefig(fichero, dpi=300, bbox_inches='tight')
    plt.close()
...
#+BEGIN_SRC jupyter-python :results file :file ./img/lecc01/funcion_logaritmica.png
...
#+RESULTS: funcion_logaritmica
: 983e1460-0508-412f-a6a4-8eacd3246761
...
#+BEGIN_SRC jupyter-python :results silent :noweb yes
fichero = './img/lecc01/funcion_logaritmica.png'
if not os.path.exists(fichero):
    <<funcion_logaritmica>>
    plt.savefig(fichero, dpi=300, bbox_inches='tight')
    plt.close()
...
#+BEGIN_SRC jupyter-python :results file :file ./img/lecc01/airlinepass_log+hist.png 
plt.figure(figsize=(15,5))
plt.subplot(1, 2, 1)
...
#+RESULTS: figura-airlinepass-log
: c7d262b5-7853-4aba-9152-13d5ccb89216
...
#+BEGIN_SRC jupyter-python :results silent :noweb yes
fichero = './img/lecc01/airlinepass_log+hist.png'
if not os.path.exists(fichero):
    <<figura-airlinepass-log>>
    plt.savefig(fichero, dpi=300, bbox_inches='tight')
    plt.close()
#+END_SRC
...
#+BEGIN_SRC jupyter-python :results silent :noweb yes
fichero = './img/lecc01/airlinepass_logDiff+hist.png'
if not os.path.exists(fichero):
    <<figura-airlinepass-log-diff>>
    plt.savefig(fichero, dpi=300, bbox_inches='tight')
    plt.close()
#+END_SRC
...
#+BEGIN_SRC jupyter-python :results silent :noweb yes
fichero = './img/lecc01/airlinepass_logDiffDiff12+hist.png'
if not os.path.exists(fichero):
    <<figura-airlinepass-log-diff-diff12>>
    plt.savefig(fichero, dpi=300, bbox_inches='tight')
    plt.close()
#+END_SRC
...
**************  Codigo aux para generar el .png de la tabla anterior :noexport:
